...
Route::delete('/usuario/grupo',[GrupoController::class,'excluiUsuarioGrupo']);
Route::get('/usuario/{id}/grupos',[GrupoController::class,'listaGruposUsuario']);
Route::get('/grupo/{id}/usuarios',[GrupoController::class,'listaUsuariosGrupo']);
Route::post('/usuario/grupo',[GrupoController::class,'usuarioGrupo']);
